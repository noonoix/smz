...
assert "complete 21-file staging bundle" in exporter
...
# Keep the inventory exact: 21 package files, of which SHA256SUMS hashes 20.
...
print("combined Guard export docs contract: current metadata, exact 21-file inventory, no legacy adafruit_hid/9.x instructions, and fail-closed calibration gate verified")
