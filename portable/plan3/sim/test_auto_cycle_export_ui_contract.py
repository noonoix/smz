...
assert "PlayOptBody" in combined_ui
assert "ساخت بسته کامل چرخه + Macro + Guard" in combined_ui
...
assert "EnsureExportCard" in combined_ui and "Reorder(body)" in combined_ui
