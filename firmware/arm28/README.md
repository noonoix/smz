...
ARM 2.8 uses one HID-Project `BootMouse` interface for movement, buttons and
...
Keep all source files in one Arduino sketch folder. Copy your existing private
...
28,648 of 28,672 bytes, so it fits the normal Caterina/Leonardo bootloader profile;
