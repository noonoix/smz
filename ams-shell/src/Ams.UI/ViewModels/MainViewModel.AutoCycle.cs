...
public partial class MainViewModel
{
    ...
    private void SaveAutoCycleOptions(string firstProperty, string secondProperty)
    {
        ...
        Log($"چرخه‌ی خودکار ذخیره شد — Restart {_settings.RestartMinMinutes}–{_settings.RestartMaxMinutes} دقیقه، " +
            $"Resume {_settings.AutoResumeMinMinutes}–{_settings.AutoResumeMaxMinutes} دقیقه، بازر {AppSettings.PortableBuzzerPin}");
    }
}
